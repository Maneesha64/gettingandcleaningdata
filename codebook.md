...
The features are normalized to have a range of [-1,1].
For the purpose of the project, other feature variables were removed and the complete list is available in 'features.txt' file in the original raw dataset.  
